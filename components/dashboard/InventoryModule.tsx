...
export function InventoryModule({
  ...
  const suggestions = [
    ["Riesgo", "Panela Orgánica se agotará en 4 días.", "red", TriangleAlert],
    ["Oportunidad", "Café Premium aumentó ventas 28%.", "green", TrendingUp],
    ["Optimización", "Reducir compras de Miel Artesanal.", "blue", RotateCw]
  ] as const;
  const kpiCards: Array<{ label: string; value: string; helper: string; icon: LucideIcon; tone: string }> = [
    ...
    { label: "Stock crítico", value: `${criticalProducts} productos`, helper: "Atención requerida", icon: TriangleAlert, tone: "amber" },
    { label: "Inventario valorizado", value: cop(inventoryValue), helper: "Valor en COP", icon: CircleDollarSign, tone: "blue" },
  ...
  return (
    <section className="inventory-command-center dashboard-module-section" data-active={isActive}>
      <header className="inventory-page-heading">
        <div>
          <h2>Inventario</h2>
          <p>Administra tu inventario, bodegas y movimientos en tiempo real.</p>
        </div>
      ...
      <article className="inventory-ai-banner">
        <div className="inventory-ai-orb"><Sparkles aria-hidden="true" /></div>
        <div>
          <span>Copiloto de inventario</span>
          <h3>La IA detectó riesgo de quiebre en 2 productos esta semana.</h3>
          <p>Reponer Panela Orgánica y reducir compra de Azúcar Integral.</p>
          <footer><small>Impacto estimado:</small><b>Evitar pérdidas por $2.400.000</b></footer>
        </div>
      ...
      <div className="inventory-layout">
        <main className="inventory-main-column">
          <section className="inventory-status-card">
            ...
            <div>
              {[
                ...
                ["Bajo inventario", 24, "10%", "amber"],
                ["Crítico", criticalProducts, "2%", "red"],
                ["Sin movimiento", 56, "23%", "gray"]
          ...
          <section className="inventory-critical-card">
            <header><strong>Productos críticos</strong></header>
            <table>
          ...
          <div className="inventory-bottom-grid">
            <section className="inventory-panel">
              <header><strong>Bodegas</strong><button type="button">Ver todas</button></header>
            ...
            <section className="inventory-panel">
              <header><strong>Movimientos recientes</strong><button type="button">Ver todas</button></header>
        ...
        <aside className="inventory-side-column">
          ...
          <section className="inventory-add-card">
            ...
            <p>Crea un nuevo producto en tu inventario.</p>
