  ...
  return (
    ...
    >
      ...
      <section className="admin-overview-grid">
        ...
        <article className="admin-health-card">
          ...
          <div>
            ...
            <p><strong>Bloqueo:</strong> {detail.subscription?.status === "past_due" ? "Acceso vencido por falta de pago" : "Sin bloqueo activo"}</p>
          </div>
        </article>
      </section>
      ...
      <AdminNextStep>
        ...
        <p>Agregar acciones operativas: cambiar plan, reenviar link de pago, bloquear/desbloquear acceso y abrir caso de soporte.</p>
      </AdminNextStep>
    </AdminShell>
  );
}
